            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('titulo') ? ' is-invalid' : '' }}" id="titulo" name="titulo" placeholder="Digite o titulo do evento..." value="{{ old('titulo') }}" required>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control{{ $errors->has('texto') ? ' is-invalid' : '' }}" id="texto" rows="3" name="texto" placeholder="Descreva o evento..." required>{{ old('texto') }}</textarea>
                        @if ($errors->has('texto'))
                        <span class="invalid-feedback" role="alert">
