...
<li class="breadcrumb-item"><a href="/admin/instituicoes-parceiras/create">Adicionar</a></li>
@endsection
@section('content')
<a href="/admin/instituicoes-parceiras" class="btn btn-secondary shadow mb-3"><i class="fas fa-arrow-left mr-2"></i>Voltar</a>
<form method="POST" action="/admin/instituicoes-parceiras" enctype="multipart/form-data" onsubmit="progressBar()">
    @csrf
