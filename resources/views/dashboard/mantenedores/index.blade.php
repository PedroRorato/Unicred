...
@endsection
@section('content')
<a href="/admin/mantenedores/create" class="btn btn-primary shadow mb-3"><i class="fas fa-plus mr-2"></i>Adicionar</a>
                ...
                <tbody>
                    @foreach($elements as $element)
                        <tr>
                            ...
                            <td>
                                <a href="/admin/mantenedores/{{ $element->id }}" class="btn btn-primary shadow" data-toggle="tooltip" title="Editar">
