...
<li class="breadcrumb-item"><a href="/admin/projetos/{{ $element->id }}">Painel do Evento</a></li>
@endsection
@section('content')
<a href="/admin/projetos" class="btn btn-secondary shadow mb-3"><i class="fas fa-arrow-left mr-2"></i>Voltar</a>
<form method="POST" action="/admin/projetos/{{ $element->id }}" enctype="multipart/form-data"  onsubmit="progressBar()">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="form-group col">
                    <img class="col mx-0 p-0" id="foto" src="{{ asset('storage/projetos/'.$element->foto) }}">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control{{ $errors->has('titulo') ? ' is-invalid' : '' }}" id="titulo" name="titulo" placeholder="Digite o nome do projeto..." value="{{ $element->titulo }}" required>
...
<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="/admin/projetos/{{ $element->id }}">
                @csrf
                @method('DELETE')
